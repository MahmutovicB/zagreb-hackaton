...
| | |
|:---|:---|
| **What it is** | A web app that turns how you *actually* live — family, commute, noise, car-free life — into **ranked neighborhoods**, a **map**, and context from **real city data**. |
| **Data** | Pulls from Zagreb’s official open data portal ([data.zagreb.hr](https://data.zagreb.hr)): communal plan, kindergartens, transit, air quality, and more. |
...
2. **Explainable recommendations** — Rankings come with **why** (transit, childcare pressure, active construction, air quality signals, etc.), not just a single number.
3. **Map-first exploration** — Neighborhoods and layers are **visual**: compare areas, spot disruption, and orient yourself geographically.
4. **Grounded in open government data** — Signals tie back to **published datasets**, not guesswork — aligned with transparency and everyday decision-making.
5. **Closer to “where do I sign?”** — Direction toward **local listings** (e.g. Njuškalo) so discovery connects to the next step of a real move.
...
| **Car-free households** | Transit and accessibility cues matter; the stack is built to **privilege** realistic daily movement. |
...
| Pillar | In short |
|:---|:---|
| **Neighborhood matchmaker** | Natural language → structured criteria → scored districts, narratives, and exploration UI. |
| **Komunalni radar** | Overlay of **Plan komunalnih aktivnosti** and related layers — works, closures, maintenance — **in context** on the map. |

Full specification, APIs, env vars, and file layout live in **[PLAN.md](PLAN.md)**.
